    ...
    a.register("dropzone/lib/dropzone.js", function (b, c, d) {
        (function () {
            ...
            j = (function (o) {
                ...
                n.prototype.defaultOptions = {url: null, method: "post", withCredentials: false, parallelUploads: 2, uploadMultiple: false, maxFilesize: 256, paramName: "file", createImageThumbnails: true, maxThumbnailFilesize: 10, thumbnailWidth: 100, thumbnailHeight: 100, maxFiles: null, params: {}, clickable: true, ignoreHiddenFiles: true, acceptedFiles: null, acceptedMimeTypes: null, autoProcessQueue: true, addRemoveLinks: false, previewsContainer: null, dictDefaultMessage: "拖拽文件进行上传", dictFallbackMessage: "你的浏览器不支持拖拽文件上传", dictFallbackText: "Please use the fallback form below to upload your files like in the olden days.", dictFileTooBig: "文件太大 ({{filesize}}MB). 最大文件尺寸: {{maxFilesize}}MB.", dictInvalidFileType: "不能上传这种类型的文件", dictResponseError: "服务器无响应，状态码： {{statusCode}}", dictCancelUpload: "取消上传", dictCancelUploadConfirmation: "你是否确定取消这次文件上传？", dictRemoveFile: "移除文件", dictRemoveFileConfirmation: null, dictMaxFilesExceeded: "You can only upload {{maxFiles}} files.", accept: function (r, q) {
                    return q()
                }, init: function () {
                    return m
